...
function updateStats() {
	...
	$.getJSON("/top_stories.php?section=all_100",
		...
		function (top_stories) {
			...
			$.ajax({
				url: 'http://api.chartbeat.com/quickstats/?host=beforeitsnews.com&path=' + encodeURIComponent(path) + '&apikey=6f69a0ed48957e9d363d037a78bc440e',
				dataType: 'jsonp',
				jsonp: 'jsonp',
...
function handleBottomFloatBar() {
	...
	$('#tumblr_link').attr('href', tumblr_button_href);
	...
	$('#digg_link').attr('href', digg_button_href);
	...
	$('#reddit_link').attr('href', reddit_button_href);

	awesm_channel = "stumbleupon-share";
//	var stumbleupon_button_href = "http://api.awe.sm/url/share?v=3&url=" + awesm_original_url + awesm_tag + "&key=" + awesm_api_key + "&tool=" + awesm_tool + "&channel=" + awesm_channel + "&destination=" + encodeURIComponent('http://www.stumbleupon.com/submit?url=AWESM_URL&title=' + stitle + '&newcomment=' + sdesc );
	...
	$('#stumbleupon_link').attr('href', stumbleupon_button_href);
...
function handleInLineStorySharing() {
	"use strict";

	$('#ilss_email_share').click(function () {
		emailShareClick();
	});
	if (blogpath === '') {
		$('#ilss_google').click(function () {
			AWESM.share.googleplus({
				'awesm_tool': 'J32PAo'
			});
		});
		$('#ilss_linkedin').click(function () {
...
var AWESM = AWESM || {};
AWESM.api_key = 'f16374303e18090baba90a39e7ae0c5ebf3bb4caf4b787ae1720bcb78f17662f';
(function() {
...
AWESM.onavailable = function() {
	...
	AWESM.fblike({
		'layout': 'button_count',
		'awesm_tool': 'J32PAo',
		'app_id': '200262433452128',
		'awesm_buttonid': 'ilss_facebook_like'
	});
	AWESM.fbshare({
		'size': 'small',
		'awesm_tool': 'J32PAo',
		'app_id': '200262433452128',
		'awesm_buttonid': 'ilss_facebook_share',
		'awesm_tag': blogpath
	});
	AWESM.tweet({
		'data-count': 'horizontal',
		'data-text': $("#headline").text(),
		'data-via': 'BeforeItsNews',
		'awesm_buttonid': 'ilss_twitter_share',
		'awesm_tool': 'J32PAo',
		'awesm_tag': blogpath
	});
	...
	AWESM.fbshare({
		...
		'awesm_tool': 'UsCqDC',
		'app_id': '200262433452128',
		'awesm_buttonid': 'bf_social_fbshare',
		'awesm_tag': blogpath
	});
	AWESM.tweet({
		'data-count': 'horizontal',
		'data-text': $("#headline").text(),
		'data-via': 'BeforeItsNews',
		'awesm_buttonid': 'bf_social_twitter',
		'awesm_tool': 'UsCqDC',
		'awesm_tag': blogpath
	});
};
