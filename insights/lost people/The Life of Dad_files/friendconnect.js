...
var friendconnect_serverVersion = "0.1-3409359c_abe3e870_4fdd5418_d86f9665_4c76704e.7";
...
fcT=function(a,b,c){fcCa(a,b,c)},fcU=function(a,b){function c(){}c.prototype=b[fc];a.Rc=b[fc];a.prototype=new c;a[fc].constructor=a;a.base=function(a,c,f){var k=fcf[fc][fcq][fcI](arguments,2);return b[fc][c][fcL](a,k)}};Function[fc].bind=Function[fc][fcoa]||function(a,b){if(1<arguments[fcB]){var c=fcf[fc][fcq][fcI](arguments,1);c.unshift(this,a);return fcS[fcL](null,c)}return fcS(this,a)};var fcLa=function(a){if(fch.captureStackTrace)fch.captureStackTrace(this,fcLa);else{var b=fch().stack;b&&(this.stack=b)}a&&(this.message=fci(a))};fcU(fcLa,fch);fcLa[fc].name="CustomError";var fcMa=function(a,b){for(var c=a[fcD]("%s"),d="",e=fcf[fc][fcq][fcI](arguments,1);e[fcB]&&1<c[fcB];)d+=c[fcha]()+e[fcha]();return d+c[fcO]("%s")},fcNa=function(a,b){var c=fci(a)[fcza](),d=fci(b)[fcza]();return c<d?-1:c==d?0:1},fcUa=function(a,b){if(b)return a[fcr](fcOa,"&amp;")[fcr](fcPa,"&lt;")[fcr](fcQa,"&gt;")[fcr](fcRa,"&quot;")[fcr](fcSa,"&#39;");if(!fcTa[fcga](a))return a;-1!=a[fcu]("&")&&(a=a[fcr](fcOa,"&amp;"));-1!=a[fcu]("<")&&(a=a[fcr](fcPa,"&lt;"));-1!=a[fcu](">")&&(a=a[fcr](fcQa,"&gt;"));
-1!=a[fcu]('"')&&(a=a[fcr](fcRa,"&quot;"));-1!=a[fcu]("'")&&(a=a[fcr](fcSa,"&#39;"));return a},fcOa=/&/g,fcPa=/</g,fcQa=/>/g,fcRa=/"/g,fcSa=/'/g,fcTa=/[&<>"']/,fcWa=function(a,b){for(var c=0,d=fci(a)[fcr](/^[\s\xa0]+|[\s\xa0]+$/g,"")[fcD]("."),e=fci(b)[fcr](/^[\s\xa0]+|[\s\xa0]+$/g,"")[fcD]("."),f=fcg.max(d[fcB],e[fcB]),k=0;0==c&&k<f;k++){var l=d[k]||"",m=e[k]||"",n=RegExp("(\\d*)(\\D*)","g"),g=RegExp("(\\d*)(\\D*)","g");do{var h=n.exec(l)||["","",""],p=g.exec(m)||["","",""];if(0==h[0][fcB]&&0==p[0][fcB])break;
var c=0==h[1][fcB]?0:fcca(h[1],10),s=0==p[1][fcB]?0:fcca(p[1],10),c=fcVa(c,s)||fcVa(0==h[2][fcB],0==p[2][fcB])||fcVa(h[2],p[2])}while(0==c)}return c},fcVa=function(a,b){return a<b?-1:a>b?1:0},fcXa=function(a){return fci(a)[fcr](/\-([a-z])/g,function(a,c){return c.toUpperCase()})},fcYa=function(a,b){var c=fcQ(b)?fci(b)[fcr](/([-()\[\]{}+?*.$\^|,:#<!\\])/g,"\\$1")[fcr](/\x08/g,"\\x08"):"\\s",c=c?"|["+c+"]+":"",c=new RegExp("(^"+c+")([a-z])","g");return a[fcr](c,function(a,b,c){return b+c.toUpperCase()})};var fcZa=function(a,b){b.unshift(a);fcLa[fcI](this,fcMa[fcL](null,b));b[fcha]();this.messagePattern=a};fcU(fcZa,fcLa);fcZa[fc].name="AssertionError";var fc_a=function(a,b,c,d){var e="Assertion failed";if(c)var e=e+(": "+c),f=d;else a&&(e+=": "+a,f=b);throw new fcZa(""+e,f||[]);},fc0a=function(a,b,c){a||fc_a("",null,b,fcf[fc][fcq][fcI](arguments,2));return a};var fc1a=fcf[fc],fc2a=fc1a[fcu]?function(a,b,c){fc0a(null!=a[fcB]);return fc1a[fcu][fcI](a,b,c)}:function(a,b,c){c=null==c?0:0>c?fcg.max(0,a[fcB]+c):c;if(fcQ(a))return fcQ(b)&&1==b[fcB]?a[fcu](b,c):-1;for(;c<a[fcB];c++)if(c in a&&a[c]===b)return c;return-1},fc3a=fc1a.forEach?function(a,b,c){fc0a(null!=a[fcB]);fc1a.forEach[fcI](a,b,c)}:function(a,b,c){for(var d=a[fcB],e=fcQ(a)?a[fcD](""):a,f=0;f<d;f++)f in e&&b[fcI](c,e[f],f,a)},fc4a=function(a,b){return 0<=fc2a(a,b)},fc5a=function(a){var b=a[fcB];
if(0<b){for(var c=fcf(b),d=0;d<b;d++)c[d]=a[d];return c}return[]},fc6a=function(a,b,c){fc0a(null!=a[fcB]);return 2>=arguments[fcB]?fc1a[fcq][fcI](a,b):fc1a[fcq][fcI](a,b,c)};var fc7a=function(){var a=fcP.navigator;return a&&(a=a.userAgent)?a:""},fc8a=fc7a(),fcV=function(a){var b=fc8a;return-1!=b[fcu](a)},fc9a=function(a){var b=fc8a;return-1!=b[fcza]()[fcu](a[fcza]())};var fc$a=function(){return fcV("Opera")||fcV("OPR")},fcab=function(){return fcV("Trident")||fcV("MSIE")},fcbb=fc$a,fccb=fcab;var fcdb=fcbb(),fcW=fccb(),fceb=fcV("Gecko")&&!fc9a("WebKit")&&!(fcV("Trident")||fcV("MSIE")),fcfb=fc9a("WebKit"),fchb=function(){var a="",b;if(fcdb&&fcP.opera)return a=fcP.opera.version,"function"==fcDa(a)?a():a;fceb?b=/rv\:([^\);]+)(\)|;)/:fcW?b=/\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/:fcfb&&(b=/WebKit\/(\S+)/);b&&(a=(a=b.exec(fc8a))?a[1]:"");return fcW&&(b=fcgb(),b>parseFloat(a))?fci(b):a},fcgb=function(){var a=fcP[fcC];return a?a.documentMode:void 0},fcib=fchb(),fcjb={},fckb=function(a){return fcjb[a]||
(fcjb[a]=0<=fcWa(fcib,a))},fclb=function(){var a=fcP[fcC];if(a&&fcW){var b=fcgb();return b||("CSS1Compat"==a.compatMode?fcca(fcib,10):5)}}();var fcmb=function(a){for(var b=[],c=0,d=0;d<a[fcB];d++){for(var e=a[fcta](d);255<e;)b[c++]=e&255,e>>=8;b[c++]=e}return b};var fcnb=null,fcob=null,fcpb=null,fcqb=null,fcsb=function(a,b){if(!fcEa(a))throw fch("encodeByteArray takes an array as a parameter");fcrb();for(var c=b?fcpb:fcnb,d=[],e=0;e<a[fcB];e+=3){var f=a[e],k=e+1<a[fcB],l=k?a[e+1]:0,m=e+2<a[fcB],n=m?a[e+2]:0,g=f>>2,f=(f&3)<<4|l>>4,l=(l&15)<<2|n>>6,n=n&63;m||(n=64,k||(l=64));d[fcn](c[g],c[f],c[l],c[n])}return d[fcO]("")},fctb=function(a,b){fcrb();for(var c=b?fcqb:fcob,d=[],e=0;e<a[fcB];){var f=c[a[fct](e++)],k=e<a[fcB],k=k?c[a[fct](e)]:0;++e;var l=e<a[fcB],
l=l?c[a[fct](e)]:0;++e;var m=e<a[fcB],m=m?c[a[fct](e)]:0;++e;if(null==f||null==k||null==l||null==m)throw fch();f=f<<2|k>>4;d[fcn](f);64!=l&&(f=k<<4&240|l>>2,d[fcn](f),64!=m&&(f=l<<6&192|m,d[fcn](f)))}return d},fcrb=function(){if(!fcnb){fcnb={};fcob={};fcpb={};fcqb={};for(var a=0;65>a;a++)fcnb[a]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/="[fct](a),fcob[fcnb[a]]=a,fcpb[a]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_."[fct](a),fcqb[fcpb[a]]=a}};var fcub=function(){this.blockSize=-1};var fcX=function(a,b,c){fcub[fcI](this);this.i=a;this.blockSize=c||a.blockSize||16;this.Xb=fcf(this.blockSize);this.Va=fcf(this.blockSize);this.Tb(b)};fcU(fcX,fcub);fcX[fc].Tb=function(a){a[fcB]>this.blockSize&&(this.i[fcM](a),a=this.i.digest(),this.i[fcya]());for(var b,c=0;c<this.blockSize;c++)b=c<a[fcB]?a[c]:0,this.Xb[c]=b^92,this.Va[c]=b^54;this.i[fcM](this.Va)};fcX[fc].reset=function(){this.i[fcya]();this.i[fcM](this.Va)};fcX[fc].update=function(a,b){this.i[fcM](a,b)};
fcX[fc].digest=function(){var a=this.i.digest();this.i[fcya]();this.i[fcM](this.Xb);this.i[fcM](a);return this.i.digest()};fcX[fc].Jb=function(a){this[fcya]();this[fcM](a);return this.digest()};var fcY=function(){fcub[fcI](this);this.blockSize=64;this.c=[];this.Ca=[];this.Ic=[];this.sa=[];this.sa[0]=128;for(var a=1;a<this.blockSize;++a)this.sa[a]=0;this.ya=this.G=0;this[fcya]()};fcU(fcY,fcub);fcY[fc].reset=function(){this.c[0]=1732584193;this.c[1]=4023233417;this.c[2]=2562383102;this.c[3]=271733878;this.c[4]=3285377520;this.ya=this.G=0};
...
fcZ[fc].remove=function(a,b,c){var d=this.M(a);this.set(a,"",0,b,c);return d};fcZ[fc].r=function(){return this.ha().keys};fcZ[fc].F=function(){return this.ha().values};fcZ[fc].P=function(){var a=this.Na();return a?this.ja()[fcB]:0};fcZ[fc].M=function(a){return fcBa(this.get(a))};fcZ[fc].clear=function(){for(var a=this.ha().keys,b=a[fcB]-1;0<=b;b--)this.remove(a[b])};fcZ[fc].wc=function(a){this.xb.cookie=a};fcZ[fc].Na=function(){return this.xb.cookie};fcZ[fc].ja=function(){return(this.Na()||"")[fcD](fcvb)};
fcZ[fc].ha=function(){for(var a=this.ja(),b=[],c=[],d,e,f=0;e=a[f];f++)d=e[fcu]("="),-1==d?(b[fcn](""),c[fcn](e)):(b[fcn](e[fcva](0,d)),c[fcn](e[fcva](d+1)));return{keys:b,values:c}};var fcwb=new fcZ(fce);fcwb.MAX_COOKIE_LENGTH=3950;var fc_=function(a,b){fcj(this,a);fcl(this,b)};fc_[fc].clone=function(){return new fc_(this[fco],this[fcN])};fc_[fc].toString=function(){return"("+this[fco]+" x "+this[fcN]+")"};fc_[fc].ceil=function(){fcj(this,fcg.ceil(this[fco]));fcl(this,fcg.ceil(this[fcN]));return this};fc_[fc].floor=function(){fcj(this,fcg.floor(this[fco]));fcl(this,fcg.floor(this[fcN]));return this};fc_[fc].round=function(){fcj(this,fcg[fcp](this[fco]));fcl(this,fcg[fcp](this[fcN]));return this};
fc_[fc].scale=function(a,b){var c="number"==typeof b?b:a;fcj(this,this[fco]*a);fcl(this,this[fcN]*c);return this};var fcxb=function(a,b,c){for(var d in a)b[fcI](c,a[d],d,a)},fcyb=function(a){var b=[],c=0,d;for(d in a)b[c++]=a[d];return b},fczb=function(a){var b=[],c=0,d;for(d in a)b[c++]=d;return b},fcAb="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" "),fcBb=function(a,b){for(var c,d,e=1;e<arguments[fcB];e++){d=arguments[e];for(c in d)a[c]=d[c];for(var f=0;f<fcAb[fcB];f++)c=fcAb[f],fcaa[fc].hasOwnProperty[fcI](d,c)&&(a[c]=d[c])}};var fcCb=!fcW||fcW&&9<=fclb;!fceb&&!fcW||fcW&&fcW&&9<=fclb||fceb&&fckb("1.9.1");fcW&&fckb("9");var fcDb=function(a,b){fcea(a,b)},fcEb=function(a){a=a.className;return fcQ(a)&&a[fcv](/\S+/g)||[]},fcGb=function(a,b){var c=fcEb(a),d=fc6a(arguments,1),e=c[fcB]+d[fcB];fcFb(c,d);fcDb(a,c[fcO](" "));return c[fcB]==e},fcFb=function(a,b){for(var c=0;c<b[fcB];c++)fc4a(a,b[c])||a[fcn](b[c])};var fcHb=function(a){return fcQ(a)?fce[fcs](a):a},fcIb=fcHb,fcJb=function(a,b,c,d){a=d||a;b=b&&"*"!=b?b.toUpperCase():"";if(a.querySelectorAll&&a.querySelector&&(b||c))return c=b+(c?"."+c:""),a.querySelectorAll(c);if(c&&a.getElementsByClassName){a=a.getElementsByClassName(c);if(b){d={};for(var e=0,f=0,k;k=a[f];f++)b==k.nodeName&&(d[e++]=k);fcda(d,e);return d}return a}a=a.getElementsByTagName(b||"*");if(c){d={};for(f=e=0;k=a[f];f++)b=k.className,"function"==typeof b[fcD]&&fc4a(b[fcD](/\s+/),c)&&(d[e++]=
k);fcda(d,e);return d}return a},fcLb=function(a,b){fcxb(b,function(b,d){"style"==d?a[fcG].cssText=b:"class"==d?fcea(a,b):"for"==d?a.htmlFor=b:d in fcKb?a[fcy](fcKb[d],b):0==d.lastIndexOf("aria-",0)||0==d.lastIndexOf("data-",0)?a[fcy](d,b):a[d]=b})},fcKb={cellpadding:"cellPadding",cellspacing:"cellSpacing",colspan:"colSpan",frameborder:"frameBorder",height:"height",maxlength:"maxLength",role:"role",rowspan:"rowSpan",type:"type",usemap:"useMap",valign:"vAlign",width:"width"},fcMb=function(a){a=a[fcC];
a="CSS1Compat"==a.compatMode?a.documentElement:a[fcH];return new fc_(a.clientWidth,a.clientHeight)},fc0=function(a,b,c){return fcNb(fce,arguments)},fcNb=function(a,b){var c=b[0],d=b[1];if(!fcCb&&d&&(d[fcz]||d[fcla])){c=["<",c];d[fcz]&&c[fcn](' name="',fcUa(d[fcz]),'"');if(d[fcla]){c[fcn](' type="',fcUa(d[fcla]),'"');var e={};fcBb(e,d);delete e[fcla];d=e}c[fcn](">");c=c[fcO]("")}c=a[fcw](c);d&&(fcQ(d)?fcea(c,d):"array"==fcDa(d)?fcGb[fcL](null,[c].concat(d)):fcLb(c,d));2<b[fcB]&&fcOb(a,c,b,2);return c},
fcOb=function(a,b,c,d){function e(c){c&&b[fcm](fcQ(c)?a.createTextNode(c):c)}for(;d<c[fcB];d++){var f=c[d];!fcEa(f)||fcFa(f)&&0<f.nodeType?e(f):fc3a(fcPb(f)?fc5a(f):f,e)}},fcPb=function(a){if(a&&"number"==typeof a[fcB]){if(fcFa(a))return"function"==typeof a.item||"string"==typeof a.item;if("function"==fcDa(a))return"function"==typeof a.item}return!1};var fcQb="StopIteration"in fcP?fcP.StopIteration:fch("StopIteration"),fcRb=function(){};fcRb[fc].next=function(){throw fcQb;};fcRb[fc].__iterator__=function(){return this};var fc1=function(a,b){this.j={};this.e=[];this.$=this.v=0;var c=arguments[fcB];if(1<c){if(c%2)throw fch("Uneven number of arguments");for(var d=0;d<c;d+=2)this.set(arguments[d],arguments[d+1])}else a&&this.ob(a)};fc1[fc].P=function(){return this.v};fc1[fc].F=function(){this.K();for(var a=[],b=0;b<this.e[fcB];b++){var c=this.e[b];a[fcn](this.j[c])}return a};fc1[fc].r=function(){this.K();return this.e.concat()};fc1[fc].M=function(a){return fcSb(this.j,a)};
fc1[fc].clear=function(){this.j={};fcda(this.e,0);this.$=this.v=0};fc1[fc].remove=function(a){return fcSb(this.j,a)?(delete this.j[a],this.v--,this.$++,this.e[fcB]>2*this.v&&this.K(),!0):!1};fc1[fc].K=function(){if(this.v!=this.e[fcB]){for(var a=0,b=0;a<this.e[fcB];){var c=this.e[a];fcSb(this.j,c)&&(this.e[b++]=c);a++}fcda(this.e,b)}if(this.v!=this.e[fcB]){for(var d={},b=a=0;a<this.e[fcB];)c=this.e[a],fcSb(d,c)||(this.e[b++]=c,d[c]=1),a++;fcda(this.e,b)}};
fc1[fc].get=function(a,b){return fcSb(this.j,a)?this.j[a]:b};fc1[fc].set=function(a,b){fcSb(this.j,a)||(this.v++,this.e[fcn](a),this.$++);this.j[a]=b};fc1[fc].ob=function(a){var b;a instanceof fc1?(b=a.r(),a=a.F()):(b=fczb(a),a=fcyb(a));for(var c=0;c<b[fcB];c++)this.set(b[c],a[c])};fc1[fc].forEach=function(a,b){for(var c=this.r(),d=0;d<c[fcB];d++){var e=c[d],f=this.get(e);a[fcI](b,f,e,this)}};fc1[fc].clone=function(){return new fc1(this)};
fc1[fc].__iterator__=function(a){this.K();var b=0,c=this.e,d=this.j,e=this.$,f=this,k=new fcRb;k.next=function(){for(;;){if(e!=f.$)throw fch("The map has changed since the iterator was created");if(b>=c[fcB])throw fcQb;var k=c[b++];return a?k:d[k]}};return k};var fcSb=function(a,b){return fcaa[fc].hasOwnProperty[fcI](a,b)};var fcUb=function(a,b,c){fcQ(b)?fcTb(a,c,b):fcxb(b,fcIa(fcTb,a))},fcTb=function(a,b,c){(c=fcVb(a,c))&&(a[fcG][c]=b)},fcVb=function(a,b){var c=fcXa(b);if(void 0===a[fcG][c]){var d=(fcfb?"Webkit":fceb?"Moz":fcW?"ms":fcdb?"O":null)+fcYa(b);if(void 0!==a[fcG][d])return d}return c},fcWb=function(a,b){var c=9==a.nodeType?a:a.ownerDocument||a[fcC];return c.defaultView&&c.defaultView.getComputedStyle&&(c=c.defaultView.getComputedStyle(a,null))?c[b]||c.getPropertyValue(b)||"":""},fcXb=function(a,b){return fcWb(a,
b)||(a.currentStyle?a.currentStyle[b]:null)||a[fcG]&&a[fcG][b]},fcYb=function(a){var b;try{b=a.getBoundingClientRect()}catch(c){return{left:0,top:0,right:0,bottom:0}}fcW&&a.ownerDocument[fcH]&&(a=a.ownerDocument,b.left=b[fcja]-(a.documentElement.clientLeft+a[fcH].clientLeft),b.top-=a.documentElement.clientTop+a[fcH].clientTop);return b},fc0b=function(a,b,c){if(b instanceof fc_)c=b[fcN],b=b[fco];else if(void 0==c)throw fch("missing height argument");fcZb(a,b);fc_b(a,c)},fc1b=function(a,b){"number"==
typeof a&&(a=(b?fcg[fcp](a):a)+"px");return a},fc_b=function(a,b){fcl(a[fcG],fc1b(b,!0))},fcZb=function(a,b){fcj(a[fcG],fc1b(b,!0))},fc2b=function(a,b){if("none"!=fcXb(b,"display"))return a(b);var c=b[fcG],d=c.display,e=c.visibility,f=c.position;c.visibility="hidden";c.position="absolute";c.display="inline";var k=a(b);c.display=d;c.position=f;c.visibility=e;return k},fc3b=function(a){var b=a.offsetWidth,c=a.offsetHeight,d=fcfb&&!b&&!c;return fcBa(b)&&!d||!a.getBoundingClientRect?new fc_(b,c):(a=fcYb(a),
new fc_(a[fcAa]-a[fcja],a.bottom-a.top))},fc4b=function(a,b){a[fcG].display=b?"":"none"};var fc5b={},fc6b={};var fc7b=function(a,b,c,d){b=b||"800";c=c||"550";d=d||"friendconnect";a=fcc.open(a,d,"menubar=no,toolbar=no,dialog=yes,location=yes,alwaysRaised=yes,width="+b+",height="+c+",resizable=yes,scrollbars=1,status=1");fcc.focus&&a&&a.focus()},fc8b=function(a,b){var c=fca[fcK][fcF]().communityId;fca.rpc[fcI](null,"signin",null,c,a,b)};fcT("goog.peoplesense.util.openPopup",fc7b);fcT("goog.peoplesense.util.finishSignIn",fc8b);var fcac=function(a,b){var c=fc9b()+"/friendconnect/invite/friends",d=fcb(shindig[fcma][fcna]());fc$b(c,d,a,b)},fc$b=function(a,b,c,d){a+="?st="+b;c&&(a+="&customMessage="+fcb(c));d&&(a+="&customInviteUrl="+fcb(d));b=760;fcW&&(b+=25);fc7b(a,fci(b),"515","friendconnect_invite")};fcT("goog.peoplesense.util.invite",fcac);fcT("goog.peoplesense.util.inviteFriends",fc$b);var fcbc=function(a){this.url=a};fcbc[fc].l=function(a,b){if(0<=this.url[fcu]("?"+a+"=")||0<=this.url[fcu]("&"+a+"="))throw fch("duplicate: "+a);if(null===b||void 0===b)return this;var c=0<=this.url[fcu]("?")?"&":"?";this.url+=c+a+"="+fcb(fci(b));return this};fcbc[fc].toString=function(){return this.url};var fc9b=function(){return fcc.friendconnect_serverBase},fccc=function(a,b,c,d,e,f,k){b=b||"800";c=c||"550";d=d||"friendconnect";f=f||!1;fca.rpc[fcI](null,"openLightboxIframe",k,a,shindig[fcma][fcna](),b,c,d,e,null,null,null,f)},fcdc=function(a,b){var c=fca[fcK][fcF]().psinvite||"",d=new fcbc(fc9b()+"/friendconnect/signin/home");d.l("st",fcc.shindig[fcma][fcna]());d.l("psinvite",c);d.l("iframeId",a);d.l("loginProvider",b);d.l("subscribeOnSignin","1");fc7b(d[fcpa]());return!1},fcec=function(){var a=
fca[fcK][fcF]().communityId;fca.rpc[fcI](null,"signout",null,a)},fcgc=function(a,b){var c=fc9b()+"/friendconnect/settings/edit?st="+fcb(shindig[fcma][fcna]())+(a?"&iframeId="+fcb(a):"");b&&(c=c+"&"+b);fcfc(c)},fchc=function(a){a=fc9b()+"/friendconnect/settings/siteProfile?st="+fcb(a);fcfc(a)},fcfc=function(a){var b=800,c=510;fcW&&(b+=25);fc7b(a,fci(b),fci(c))},fcic=function(a,b,c,d){d=d||2;var e=null;if("text"==b)e=fc0("div",{"class":"gfc-button-text"},fc0("div",{"class":"gfc-icon"},fc0("a",{href:"javascript:void(0);"},
...
cellpadding:"0",cellspacing:"0"},fc0("tbody",{"class":""},fc0("tr",{"class":""},fc0("td",{"class":"gfc-button-base-v2 gfc-button-1"}),fc0("td",{"class":"gfc-button-base-v2 gfc-button-2"},c),fc0("td",{"class":"gfc-button-base-v2 gfc-button-3"})))),a[fcm](e),"standard"==b&&(b=fc0("div",{"class":"gfc-footer-msg"},"with Google Friend Connect"),1==d&&a[fcm](fc0("br")),a[fcm](b));return e},fcjc=function(a,b){if(!a)throw"google.friendconnect.renderSignInButton: missing options";var c=a[fcG]||"standard",
d=a.text,e=a.version;if("standard"==c)d=a.text||"Sign in";else if("text"==c||"long"==c)d=a.text||"Sign in with Friend Connect";var f=a.element;if(!f){f=a.id;if(!f)throw"google.friendconnect.renderSignInButton: options[id] and options[element] == null";f=fcIb(f);if(!f)throw"google.friendconnect.renderSignInButton: element "+a.id+" not found";}fck(f,"");c=fcic(f,c,d,e);fcc[fcx]?c[fcx]("click",b,!1):c.attachEvent("onclick",b)},fckc=function(a,b){b=b||fcS(fcdc,null,null,null,null);fcjc(a,b)},fclc=function(a,
b){fca.rpc[fcI](null,"putReloadViewParam",null,a,b);var c=fca.views.getParams();c[a]=b},fcmc=function(a,b){var c=new fcbc("/friendconnect/gadgetshare/friends");c.l("customMessage",a);c.l("customInviteUrl",b);c.l("container","glb");var d=310;fcW&&(d+=25);fccc(c[fcpa](),fci(d),"370")};fcT("goog.peoplesense.util.getBaseUrl",fc9b);fcT("goog.peoplesense.util.finishSignIn",fc8b);fcT("goog.peoplesense.util.signout",fcec);fcT("goog.peoplesense.util.signin",fcdc);fcT("goog.peoplesense.util.editSettings",fcgc);
fcT("goog.peoplesense.util.editSSProfile",fchc);fcT("goog.peoplesense.util.setStickyViewParamToken",fclc);fcT("google.friendconnect.renderSignInButton",fckc);fcT("goog.peoplesense.util.share",fcmc);fcT("goog.peoplesense.util.userAgent.IE",fcW);var fcnc={},fc2=function(a){this.h=new fc1;this.snippetId=a.id;this.site=a.site;a=a["view-params"];var b=a.skin;this.hc=(b?b.POSITION:"top")||"top";this.Jc={allowAnonymousPost:a.allowAnonymousPost||!1,scope:a.scope||"SITE",docId:a.docId||"",features:a.features||"video,comment",startMaximized:"true",disableMinMax:"true",skin:b};this.absoluteBottom=fcW&&!fckb("7");this.fixedIeSizes=fcW;fcc[fcx]?fcc[fcx]("resize",fcS(this.eb,this),!1):fcc.attachEvent("onresize",fcS(this.eb,this));this.tb()};
fc2[fc].tb=function(){if(!this.site)throw fch("Must supply site ID.");if(!this.snippetId)throw fch("Must supply a snippet ID.");};fc2[fc].b=10;fc2[fc].Ba=1;fc2[fc].q="fc-friendbar-";fc2[fc].t=fc2[fc].q+"outer";fc2[fc].hb=fc2[fc].t+"-shadow";fc2[fc].render=function(){fce.write(this.Bb());var a=fcHb(this.snippetId);fck(a,this.O())};fc2[fc].Cb=function(){var a=fcHb(this.t);return a=fc2b(fc3b,a)[fco]};fc2[fc].eb=function(){for(var a=this.h.r(),b=0;b<a[fcB];b++)this.tc(a[b]);goog&&fc5b&&fc6b&&fcoc&&fcpc("resize")};
...
fc2[fc].Fc=function(a,b){var c=this.h.get(a);if(c){c.drawer||(c.drawer=fcHb(this.fa(c[fcz])),c.target=fcHb(this.R(c[fcz])),c.sha_bc=fcJb(fce,"div","top"==this.n()?this.d("bc"):this.d("tc"),c.drawer)[0],c.sha_cr=fcJb(fce,"div",this.d("cr"),c.drawer)[0]);for(var d=this.h.r(),e=0;e<d[fcB];e++){var f=d[e];a!==f&&this.ma(f)}c.da(b);fc4b(c.drawer,!0);fcc.setTimeout(function(){c.Aa();c.Ka();c.render()},0)}};
...
fc3[fc].da=function(a){fcBb(this.constraints,a||{});fcBb(this.skin,this.constraints);if(this.bar.fixedIeSizes&&this.constraints[fcja]&&this.constraints[fcAa]){a=this.bar.Cb();var b=this.constraints[fcja],c=this.constraints[fcAa];a-=b+c;a%2&&(a-=1,this.skin.right=this.skin[fcAa]+1);fcj(this.skin,a);delete this.skin[fcja]}};
fc3[fc].Aa=function(){if(this.drawer){if(this.skin[fco]){var a=this.bar.Ba,b=this.bar.b,c=fcW?2:0;fc0b(this.target,this.skin[fco],"");fc0b(this.sha_bc,this.skin[fco]-b+2*a-c,"");this.skin.rightShadow?fc0b(this.drawer,this.skin[fco]+b+2*a-c,""):fc0b(this.drawer,this.skin[fco]+2*a-c,"")}this.skin[fcAa]&&(this.drawer[fcG].right=this.skin[fcAa]+0+"px")}};
fc3[fc].Ka=function(){if(fcW&&this.drawer){var a=fc2b(fc3b,this.target),b=a[fco]-this.bar.b,a=a[fcN];0>b&&(b=0);this.sha_bc&&this.sha_bc[fcG]&&fc0b(this.sha_bc,b,"");this.sha_cr&&this.sha_cr[fcG]&&fc0b(this.sha_cr,"",a)}};
...
fc3[fc].render=function(){if(!1==this.rendered){var a={};a.url=this.url;a.id=this.bar.R(this[fcz]);a.site=this.bar.site;a["view-params"]=fcR(this.bar.Jc);"profile"==this[fcz]&&(a["view-params"].profileId="VIEWER");this.skin&&fcBb(a["view-params"].skin,this.skin);a["view-params"].menuName=this[fcz];a["view-params"].opaque="true";a["view-params"].menuPosition=this.bar.hc;fcl(a,"1px");fcc.google&&fcnc&&fc4&&(this.id=fc4.render(a))}};fcT("google.friendconnect.FriendBar",fc2);var fcqc="0123456789abcdefghijklmnopqrstuv",fcsc=function(a){a=new fcrc(a);if(a.qa()%5)throw fch();for(var b=[],c=0;0<a.qa();c++)b[c]=fcqc[fct](a.fc(5));return b[fcO]("")},fcrc=function(a){this.H=this.o=0;this.ca=a};fcrc[fc].qa=function(){return 8*(this.ca[fcB]-this.H)-this.o};
fcrc[fc].fc=function(a){var b=0;if(a>this.qa())throw fch();if(0<this.o){var b=255>>this.o&this.ca[this.H],c=8-this.o,d=fcg.min(a%8,c),c=c-d,b=b>>c;a-=d;this.o+=d;8==this.o&&(this.o=0,this.H++)}for(;8<=a;)b<<=8,b|=this.ca[this.H],this.H++,a-=8;0<a&&(b<<=a,b|=this.ca[this.H]>>8-a,this.o=a);return b};var fctc=(new Date).getTime(),fc5=function(){},fcuc=function(){},fcvc=function(){},fcwc=function(){};fcU(fcwc,fcvc);var fcxc=function(a){if(a)for(var b in a)a.hasOwnProperty(b)&&(this[b]=a[b]);if(this.viewParams)for(var c in this.viewParams)/^FC_RELOAD_.*$/[fcga](c)&&(this.viewParams[c]=null)};fcxc[fc].render=function(a){var b=this;a&&(b.Hc(),this.Eb(function(c){fcUb(a,"visibility","hidden");fck(a,c);b.refresh(a,c);c=function(a){fcUb(a,"visibility","visible")};c=fcIa(c,a);fcba(c,500);b.chrome=a}))};
fcxc[fc].Eb=function(a){return this.Kb(a)};var fc6=function(a){fcxc[fcI](this,a);this.V="../../";this.rpcToken=fci(fcg[fcp](2147483647*fcg.random()))};fcU(fc6,fcxc);fc6[fc].mb="gfc_iframe_";fc6[fc].nb="friendconnect";fc6[fc].La="";fc6[fc].uc="rpc_relay.html";fc6[fc].Y=function(a){this.V=a};fc6[fc].Hc=function(){return this.La=fci(fcg[fcp](2147483647*fcg.random()))};fc6[fc].ga=function(){return this.mb+this.La+"_"+this.id};
...
l));e.caller=fcyc();e.rpctoken=this.rpcToken;l=!1;d="";k=/Version\/3\..*Safari/;if((k=fcfb&&fc8a[fcv](k))||!fc4.S[this.specUrl]&&this.viewParams)e["view-params"]=fca[fcsa][fcfa](this.viewParams),d="?viewParams="+fcb(e["view-params"]),l=!0;this.prefs&&(e.prefs=fca[fcsa][fcfa](this.prefs));this.viewParams&&this.sendViewParamsToServer&&(e["view-params"]=fca[fcsa][fcfa](this.viewParams));this[fcka]&&(e.locale=this[fcka]);this.secureToken&&(e.st=this.secureToken);k=fc4.Ra(this.specUrl);d=k+"ifr"+d+(this.hashData?
"&"+this.hashData:"");1!=fc4.Lc||l||f||this.secureToken?f&&!e.sig&&(e.fcauth=f):e.sig||(c="get");f=this.ga();fczc(f,d,c,e,a,b,this.rpcToken)};var fc7=function(){this.k={};this.T="http://"+fce[fcE].host;this.aa="default";this.gc=1;this.Qc=0;this.Nc="US";this.Oc="en";this.Pc=2147483647};fcU(fc7,fcuc);fc7[fc].w=fcxc;fc7[fc].B=new fcwc;fc7[fc].gb=function(a){this.gc=a};fc7[fc].Ja=function(a){this.Lc=a};fc7[fc].Qa=function(a){return"gadget_"+a};fc7[fc].A=function(a){return this.k[this.Qa(a)]};
fc7[fc].N=function(a){return new this.w(a)};fc7[fc].pb=function(a){a.id=this.Lb();this.k[this.Qa(a.id)]=a};fc7[fc].ec=0;fc7[fc].Lb=function(){return this.ec++};var fcBc=function(){fc7[fcI](this);this.B=new fcAc};fcU(fcBc,fc7);fcBc[fc].w=fc6;fcBc[fc].X=function(a){a[fcv](/^http[s]?:\/\//)||(a=fce[fcE][fcua][fcv](/^[^?#]+\//)[0]+a);this.T=a};fcBc[fc].J=function(a){var b=this.B.Pa(a);a.render(b)};var fcAc=function(){this.Ab={}};fcU(fcAc,fcvc);
fcAc[fc].qb=function(a,b){this.Ab[a]=b;var c=fce[fcs](b).className;c||0!=c[fcB]||fcea(fce[fcs](b),"gadgets-gadget-container")};fcAc[fc].Pa=function(a){return(a=this.Ab[a.id])?fce[fcs](a):null};var fc8=function(a){fc6[fcI](this,a);a=a||{};this.aa=a.view||"profile"};fcU(fc8,fc6);fc8[fc].sb="canvas.html";fc8[fc].yb="/friendconnect/embed/";
var fcyc=function(){var a="1"==fca[fcK][fcF]().canvas||"1"==fca[fcK][fcF]().embed,b=null;a&&(b=fca[fcK][fcF]().caller);b||(a=fce[fcE],b=a.search[fcr](/([&?]?)psinvite=[^&]*(&?)/,function(a,b,e){return e?b:""}),b=a.protocol+"//"+a.hostname+(a.port?":"+a.port:"")+a.pathname+b);return b};fc8[fc].Dc=function(a){this.aa=a};fc8[fc].la=function(){return this.aa};fc8[fc].getBodyId=function(){return this.ga()+"_body"};
...
fc8[fc].Db=function(){var a=fcyc(),a="canvas=1&caller="+fcb(a),b=fca[fcK][fcF]().psinvite;b&&(a+="&psinvite="+fcb(b));a+="&site="+fcb(this.communityId);b=fcR(this.viewParams);if(null!=b.skin)for(var c="BG_IMAGE BG_COLOR FONT_COLOR BG_POSITION BG_REPEAT ANCHOR_COLOR FONT_FACE BORDER_COLOR CONTENT_BG_COLOR CONTENT_HEADLINE_COLOR CONTENT_LINK_COLOR CONTENT_SECONDARY_TEXT_COLOR CONTENT_SECONDARY_LINK_COLOR CONTENT_TEXT_COLOR ENDCAP_BG_COLOR ENDCAP_LINK_COLOR ENDCAP_TEXT_COLOR CONTENT_VISITED_LINK_COLOR ALTERNATE_BG_COLOR".split(" "),d=
...
var fc9=function(){fcBc[fcI](this);fca.rpc[fcA]("signin",fc5[fc].signin);fca.rpc[fcA]("signout",fc5[fc].signout);fca.rpc[fcA]("resize_iframe",fc5[fc].fb);fca.rpc[fcA]("set_title",fc5[fc].setTitle);fca.rpc[fcA]("requestNavigateTo",fc5[fc].cb);fca.rpc[fcA]("api_loaded",fc5[fc].za);fca.rpc[fcA]("createFriendBarMenu",fc5[fc].Fa);fca.rpc[fcA]("showFriendBarMenu",fc5[fc].ib);fca.rpc[fcA]("hideFriendBarMenu",fc5[fc].Ua);fca.rpc[fcA]("putReloadViewParam",fc5[fc].Za);fca.rpc[fcA]("getViewParams",fc5[fc].Ia);
fca.rpc[fcA]("getContainerBaseTime",fc5[fc].Ha);fca.rpc[fcA]("openLightboxIframe",fc5[fc].Ya);fca.rpc[fcA]("showMemberProfile",fc5[fc].kb);fca.rpc[fcA]("closeLightboxIframe",fcS(this.u,this));fca.rpc[fcA]("setLightboxIframeTitle",fcS(this.zc,this));fca.rpc[fcA]("refreshAndCloseIframeLightbox",fcS(this.ic,this));var a=fcCc;a[fcA]();a.lb(this,"load",this.Rb);a.lb(this,"start",this.Sb);this.V="../../";this.X("");this.gb(0);this.Ja(1);this.pa=null;this.apiVersion="0.8";this.openSocialSecurityToken=null;
this.W="";this.Ga={};this.Zb=null;this.Yb=!1;this.wb=this.bc=this.lastIframeLightboxOpenArguments=this.lastLightboxCallback=this.lastLightboxDialog=null;this.Mc="post"};fcU(fc9,fcBc);fc9[fc].xc=function(a){this.wb=a};fc9[fc].w=fc8;fc9[fc].S={};fc9[fc].Bc=function(a){this.pa=a};fc9[fc].Ra=function(a){var b=fc9[fc].S[a];if(!b)if(0!==this.pa[fcu]("https://")){var b=this.ub(a),c="//";0==a[fcu]("https://")?c="https://":0==a[fcu]("http://")&&(c="http://");b=[c,b,this.pa][fcO]("")}else b=this.pa;return b};
fc9[fc].ub=function(a){var b=new fcY;a=fcmb(a);b[fcM](a);b=b.digest();return b=fcsc(b)};
var fcDc=function(a,b){var c=b?b:fcc.top,d=c.frames;try{if(c.frameElement.id==a)return c}catch(e){}for(c=0;c<d[fcB];++c){var f=fcDc(a,d[c]);if(f)return f}return null},fczc=function(a,b,c,d,e,f,k){var l="gfc_load_"+a;b='<html><head><style type="text/css">body {background:transparent;}</style>'+(fcW?'<script type="text/javascript">window.goback=function(){history.go(-1);};setTimeout("goback();", 0);\x3c/script>':"")+"</head><body><form onsubmit='window.goback=function(){};return false;' style='margin:0;padding:0;' id='"+
l+"' method='"+c+"' ' action='"+fca[fcK].escapeString(b)+"'>";for(var m in d)b+="<input type='hidden' name='"+fca[fcK].escapeString(m)+"' value='' >";b+="</form></body></html>";c=fcDc(a);var n;try{n=c[fcC]||c.contentWindow[fcC]}catch(g){e&&f&&(fck(e,""),fck(e,f),c=fcDc(a),n=c[fcC]||c.contentWindow[fcC])}k&&fca.rpc.setAuthToken(a,k);n.open();n.write(b);n.close();a=n[fcs](l);for(m in d)a[m].value=d[m];if(fcW)a.onsubmit();a.submit()};
fc9[fc].zb=function(){var a=fca[fcK][fcF]().fcsite,b=fca[fcK][fcF]().fcprofile;a&&b&&fc4.xa(b,a)};fc9[fc].yc=function(a,b){this.S[a]=b};fc9[fc].U=function(){var a=/Version\/3\..*Safari/;if(a=fcfb&&fc8a[fcv](a))fce[fcE].reload();else{null!=fc4.g&&fc4.g.refresh();for(var b in fc4.k)a=fc4.k[b],this.J(a);null!=this.lastIframeLightboxOpenArguments&&(b=this.lastIframeLightboxOpenArguments,this.u(),this.ra[fcL](this,b))}};
fc9[fc].X=function(a){a[fcv](/^http[s]?:\/\//)||(a=a&&0<a[fcB]&&"/"==a[fcva](0,1)?fce[fcE][fcua][fcv](/^http[s]?:\/\/[^\/]+\//)[0]+a[fcva](1):fce[fcE][fcua][fcv](/^[^?#]+\//)[0]+a);this.T=a};fc9[fc].ea=function(a){return"fcauth"+a};fc9[fc].ka=function(a){return"fcauth"+a+"-s"};fc9[fc].hash=function(a,b){var c=new fcY,d=fctb(a,!0),c=new fcX(c,d,64),d=fcmb(b),c=c.Jb(d);return fcsb(c,!0)};fc9[fc].Ma=function(a){return a=fcwb.get(this.ea(a))||fcwb.get(this.ka(a))||this.Ga[a]||""};
...
fc9[fc].jb=function(a,b){a=a||{};var c=a[fcka],d=fcEc(c),e=this;this.u();this.Z(function(b){var c=fc0("div",{},fc0("div",{id:"gadget-signin",style:"background-color:#ffffff;height:32px;"}),fc0("div",{id:"gadget-lb-canvas",style:"background-color:#ffffff;"}));b.getTitleTextElement()[fcm](fc0("div",{id:"gfc-canvas-title",style:"color:#000000;"}));b[fcwa]()[fcm](c);b.setVisible(!0);var c=fcR(a),l=fcMb(fcc),m=fcg[fcp](0.7*l[fcN]),l={BORDER_COLOR:"#cccccc",ENDCAP_BG_COLOR:"#e0ecff",ENDCAP_TEXT_COLOR:"#333333",
ENDCAP_LINK_COLOR:"#0000cc",ALTERNATE_BG_COLOR:"#ffffff",CONTENT_BG_COLOR:"#ffffff",CONTENT_LINK_COLOR:"#0000cc",CONTENT_TEXT_COLOR:"#333333",CONTENT_SECONDARY_LINK_COLOR:"#7777cc",CONTENT_SECONDARY_TEXT_COLOR:"#666666",CONTENT_HEADLINE_COLOR:"#333333"};c.id="gadget-lb-canvas";fcl(c,fcg.min(498,m)+"px");c.maxHeight=m;c.keepMax&&(fcl(c,m),fcUb(b[fcwa](),"height",m+35+"px"));c["view-params"]=c["view-params"]||{};c["view-params"].opaque=!0;c["view-params"].skin=c["view-params"].skin||{};fcJa(c["view-params"].skin,
...
var fcHc=function(a){var b;if(a.multiple){b=[];for(var c=0;c<a[fcJ][fcB];c++)a[fcJ][c].selected&&b[fcn](a[fcJ][c].value);c=a.getAttribute("x-max");try{c*=1}catch(d){c=0}if(c&&b[fcB]>c&&a["x-selected"])for(b=a["x-selected"],c=0;c<a[fcJ][fcB];c++){a[fcJ][c].selected=!1;for(var e=0;e<b[fcB];e++)if(a[fcJ][c].value==b[e]){a[fcJ][c].selected=!0;break}}}else b=a[fcJ][a.selectedIndex].value;a["x-selected"]=b;(c=a.getAttribute("x-var"))&&fcc.opensocial[fcia]&&fcc.opensocial[fcia].getDataContext().putDataSet(c,
...
fc9[fc].Ec=function(a,b){this.Z(function(c){var d=fce.createTextNode("Copy & paste this code into your site.");c[fcwa]()[fcm](d);c[fcwa]()[fcm](fce[fcw]("br"));var d=fc4.C(a,b),e=fce[fcw]("textarea");fck(e,d);e[fcy]("style","width:500px;");c[fcwa]()[fcm](e);c.setVisible(!0)})};var fcIc="ar dv fa iw he ku pa sd tk ug ur yi".split(" "),fcEc=function(a){var b=!1;a?(a=a[fcD]("_")[0],b=fc4a(fcIc,a)):b=(a=fcWb(fce[fcH],"direction"))&&"rtl"==a;return b};
...
fc9[fc].Hb=function(a){var b=null;(a=this.Q(a))&&a.communityId&&(b=a.communityId);return b};var fcFc=function(a){fc4.I&&fcdc(fc4.I,a)},fcJc=function(){fc5[fc].signout(fc4.openSocialSiteId)},fcKc=function(){fcgc(fc4.I)},fcLc=function(a,b){fcac(a,b)},fcoc=function(){this.p={}};fcoc[fc].register=function(){fca.rpc[fcA]("subscribeEventType",fc5[fc].subscribe);fca.rpc[fcA]("publishEvent",fc5[fc].publish)};fc5[fc].subscribe=function(a){var b=fcCc;b.p[a]=b.p[a]||[];a=b.p[a];a[a[fcB]]={frameId:this}};
fcoc[fc].lb=function(a,b,c){var d=this;d.p[b]=d.p[b]||[];b=d.p[b];b[b[fcB]]={container:a,callback:c}};fc5[fc].publish=function(a){var b=fcCc,c=0;this.f&&(c=fc$(this.f));b.p[a]=b.p[a]||[];for(var b=b.p[a],d=0;d<b[fcB];d++)b[d].container?b[d].callback[fcI](b[d].container,a,c):fca.rpc[fcI](b[d].frameId,a,null,a,c)};var fcpc=fcS(fc5[fc].publish,new fc5),fcCc=new fcoc,fc4=new fc9;fc4.Da(fc4.zb);fcT("google.friendconnect.container",fc4);fcT("google.friendconnect.container.refreshGadgets",fc4.U);
...
google.friendconnect.container.setDateStamp_('14588d9e01c');