...
(function(){ 
var img= new Image(); 
img.src= "http://www.usatoday.com/_common/_images/clear.gif?start&amp;cb=" + parseInt(Math.random() * 1000); 
})();
var t3= new Date(); 

/*DoubleClick Tag*/
function doDoublClick() {
  var c = new Object;
      c.acadiana = 'mlmla207';
      c.alexandria = 'mlmal524';
      c.atlanta = 'mlmat844';
      
      c.baltimore = 'mlmba258';
      c.bigsky = 'mlmgr701';
      c.binghamton = 'mlmbi775';
      c.boston = 'mlmbo946';
      c.brevardcounty = 'mlmbr713';
      c.buffalo = 'mlmbu588';
      c.burlington = 'mlmbu202';
      
      c.cincinnati = 'mlmci554';
      c.centralalabama = 'mlmmo255';
      c.centraljersey = 'mlmce538';
      c.centralminnesota = 'mlmst521';
      c.centralwisconsin = 'mlmce096';
      c.charlotte = 'mlmch309';
      c.chicago = 'mlmch358';
      c.cleveland = 'mlmcl001';
      c.columbia = 'mlmco837';
      c.columbus = 'mlmnn881';
      ...
      c.dc = 'mlmwa028';
      c.delmarva = 'mlmsa627';
      c.desmoines = 'mlmde360';
      c.denver = 'mlmde987';
      c.detroit = 'mlmde067';
      
      c.firstcoast = 'mlmja779';
      
      c.grandrapids = 'mlmgr403';
      c.gulfcoast = 'mlmfo963';
      
      c.hartford = 'mlmha683';
      c.hattiesburg = 'mlmha408';
      c.hawaii = 'mlmho409';
      //c.houston = 'mlmho165';
      c.houston = 'mlmho433';
      c.hudsonvalley = 'mlmwe829'
      
      c.indianapolis = 'mlmin594';
      c.ithaca = 'mlmit643';
      
      c.jacksonms = 'mlmja829';
      c.jacksontn = 'mlmja249';
      c.jerseyshore = 'mlmas252';
      
      c.lafayette = 'mlmla462';
      c.lansing = 'mlmla181';
      c.littlerock = 'mlmli246';
      c.louisville = 'mlmlo347';
      c.losangeles = 'mlmlo656';
      
      c.maine = 'mlmba318';
      c.miami = 'mlmmi794';
      c.middlegeorgia = 'mlmma239';
      c.monroe = 'mlmmo356';
      c.muncie = 'mlmmu579';
      
      c.nashville = 'mlmna215';
      c.newyorkcity = 'mlmne537';
      c.northerncolorado = 'mlmfo014';
      
      c.orlando = 'mlmor991';
      c.ozark = 'mlmsp060';
      
      c.pensacola = 'mlmpe086';
      c.pittsburgh = 'mlmpi318';
      //c.philadelphia = 'mlmph860';
      c.philadelphia = 'mlmph248';
      //c.phoenix = 'mlmph983';
      c.phoenix = 'mlmph087';
      c.pittsburgh = 'mlmpi687';
      c.portland = 'mlmpo083';
      ...
      c.redriver = 'mlmsh256';
      c.reno = 'mlmre149';
      c.rochester = 'mlmro740';
      
      c.sacramento = 'mlmsa447';
      c.salem = 'mlmsa115';
      //c.sandiego = 'mlmsa379';
      c.sandiego = 'mlmsa240';
      c.sanfrancisco = 'mlmsa103';
      //c.seattle = 'mlmse797';
      c.seattle = 'mlmse769';
      c.siouxfalls = 'mlmsi257';
      c.southernutah = 'mlmst824';
      c.southjersey = 'mlmch723';
      c.stlouis = 'mlmst884';
      
      c.tallahassee = 'mlmta915';
      //c.tampabay = 'mlmta953';
      c.tampabay = 'mlmta609';
      c.triad = 'mlmgr294';
      c.twincities = 'mlmmi278';
      c.twintiers = 'mlmel495';
      
      c.upstatesc = 'mlmgr213';
      
      c.www = 'mlmna137';
      //c.cozi = 'mlmna137';
      var dh = window.location.hostname.split(".");
  if(typeof c[dh[0]] != 'undefined') {
    var axel = Math.random()+"";
    var a = axel * 10000000000000;
    var wrt =  '<IFRAME SRC="http://fls.doubleclick.net/activityi;src=1992280;type=momsl364;cat=' + c[dh[0]] + ';ord=1;num=' + a + '?" WIDTH=1 HEIGHT=1 FRAMEBORDER=0></IFRAME>';
    try {
      document.getElementById('header').innerHTML = document.getElementById('header').innerHTML + wrt;
    } catch(e) {
...
/*-------deactivating the post click only tracking -- enables post impression tracking:

REACTIVATING: the post click impression tracking - Joseph Youngquist, August 31st, 2009 -------*/
var myLoc = window.location.search.toLowerCase();
if(myLoc.indexOf('timlm') != -1){
  addListener(this, "load", function() { doDoublClick(); });
}  
...
s.linkDownloadFileTypes="exe,zip,wav,mp3,mp4,m4v,mov,mpg,avi,wmv,doc,pdf,xls"
s.linkInternalFilters="javascript:,job,career,careerbuilder,salary,network,usatoday,cars,apartments,homescape,homefinder,eharmony,customwire.ap.org,gannettnewsservice,customcoupon,newsbank,newslibrary,pictopia,topix,infi,gbahn,momslikeme"
...
function s_gnt_doPlugins(s) {
  /* Add calls to plugins here */
  if (window.s_prePlugins) { s_prePlugins(s) }
  if (typeof gnt_PageVars != 'undefined') {
    if (gnt_PageVars.pg !=''){
      s.pageName = "Moms: " + gnt_PageVars.pg;
      s.pageName = s.pageName.replace("Settings","Index");
    } 
    if(typeof gnt_PageVars.gn != 'undefined') {
      s.prop1 = gnt_PageVars.gn;
    }
    if(typeof gnt_PageVars.gzip != 'undefined') {
      s.prop2 = gnt_PageVars.gzip;
    }
    if(typeof gnt_PageVars.mzp != 'undefined') {
      s.prop3 = gnt_PageVars.mzp;
    }
    if(typeof gnt_PageVars.nk != 'undefined') {
      s.prop4 = gnt_PageVars.nk;
    }
    if(typeof gnt_PageVars.mgrp != 'undefined') {
      s.prop5 = gnt_PageVars.mgrp;
    }
    if(typeof gnt_PageVars.kgrp != 'undefined') {
      s.prop6 = gnt_PageVars.kgrp;
    }
    if(typeof gnt_PageVars.pc != 'undefined') {
      s.prop7 = gnt_PageVars.pc;
    }
    if(typeof gnt_PageVars.gtype != 'undefined') {
      s.prop8 = gnt_PageVars.gtype;
    }
    if(typeof gnt_PageVars.dob != 'undefined') {
      var gnt_dob = new Date(gnt_PageVars.dob);
      s.prop9 = gnt_dob.getFullYear();
    }
  } else if(gciDocURL.indexOf('coupons')!=-1) {
    s.pageName = "Moms: Coupons";
  }

  s.prop10 = gciDocURL; //full URL to page
  s.prop11 = s.pageName;
  s.prop12 = (function(){
	var section = gnt_PageVars.pg.split(":")[0];
	switch(section){
		case "Home Page": return "Home";
		case "Mom to Mom": return "Discussions";
		case "Login": return "My Stuff";
		default: return section;
	}
  })();
  
  s.prop13=s.getQueryParam('g');
  
  if (window.s_postPlugins) { s_postPlugins(s) }
  
  
  s.campaign=s.getQueryParam('source') // Campaign tracking:added by Omniture on 10/5/07
     
    /* Campaign Pathing : check for Campaign and populate prop26 with path */
    var tc = s.campaign;
    var pn = s.pageName;
    var isCurrent = s.c_r('tc');
    if(tc) {s.prop26 = tc +": "+pn;s.c_w('tc',tc,0)}
    if(isCurrent && !tc){s.prop26=isCurrent + ':' + pn}
    if(tc && isCurrent!=tc){s.prop26 = tc +" : "+pn;s.c_w('tc',tc,0)}
