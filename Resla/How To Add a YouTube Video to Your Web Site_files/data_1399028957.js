...
{o=o||{};var ld=o.logDocument||"al.asp";var url='http://'+this.server+'/'+ld+'?ts='+$iTXT.glob.params.get('ts','');if(this.demoMode)
{url+="&demogen=1";}
...
if(ad.avSent)
{return;}
if(!ad.params.getBool('js.temp.av1',false)){ad.avSent=true;}}
o=o||{};if(ad.oldDid)
